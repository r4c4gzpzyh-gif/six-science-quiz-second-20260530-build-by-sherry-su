    ...
    },
{
        "id": 47,
        "type": "choice",
        "question": "在校园生物大搜索中，要清晰地观察到昆虫的身体分头、胸、腹三部分，头上有一对触角，建议用（ ）观察。",
    ...
    },
{
        "id": 158,
        "type": "choice",
        "question": "小林培养微生物，方案如下表：（1号：纯净水，窗台；2号：鱼塘水，窗台；3号：沟渠水+干稻草，窗台；4号：纯净水+干稻草，冰箱）。这种研究方法能够培养出微生物的实验属于（ ）。",
    ...
    },
{
        "id": 170,
        "type": "choice",
        "question": "东方明珠电视塔高达468米，使得它保持屹立不倒的结构上的设计不包含（ ）",
    ...
    },
{
        ...
        "options": ["模型①", "模型②", "模型③", "模型④", "模型⑤","都可以"],
        "answer": 5,
        "explanation": "实际上昼夜交替由地球自转引起，但符合的假说有很多种",
        "difficulty": 2,
        "grade": 6,
        "category": "其他"
    },
{
        "id": 300,
        "type": "choice",
        "question": "（模型①：太阳不动，地球自转；模型②：太阳不动，地球公转；模型③：地球不动，太阳绕地球转；模型④：地球自转并绕太阳公转；模型⑤：太阳绕地球转，地球自转）最符合'地心说'理论的是（ ）；与地球在宇宙中的真实运动最接近的是（ ）。",
        "options": ["模型①、模型②", "模型②、模型④", "模型③、模型④", "模型④、模型③", "模型⑤、模型④"],
        "answer": 2,
    ...
    },
{
        "id": 306,
        "type": "choice",
        "question": "在四种情况中，只有一种情况小石块能撬动大石块，根据测试经验，你认为是哪一种？",
    ...
    },
{
        "id": 373,
        "type": "choice",
        "question": "电磁铁在左边，装有磁铁的小车在右边，车上磁铁左端是S极，右端是N极。当开关闭合时小车向左运动，可以判断电磁铁的右端是（ ）。",
        "options": ["N极", "S极", "不确定"],
        "answer": 0,
        "explanation": "小车向左运动说明电磁铁与小车上的磁铁相互吸引，根据磁极相互作用可判断电磁铁右端为N极。",
        "difficulty": 2,
        "grade": 6,
        "category": "其他"
    },
    ...
    },
{
        ...
        "answer": 1,
        "explanation": "滚摆上升过程中，速度减小、高度增加，动能转化为重力势能。秋千从高处荡向低处是重力势能转化为动能。弓箭射出是弹性势能转化为动能。汽车加速是燃油的化学能转化为动能。",
        "difficulty": 2,
        "grade": 6,
        "category": "其他"
    },
    ...
    },
{
        ...
        "options": ["放大倍数越大，视野越大", "放大倍数越大，看到的星体越亮", "望远镜的口径越大，看到的星体越亮", "所有望远镜都只能白天使用"],
        "answer": 2,
    ...
    },
{
        ...
        "options": ["使用杠杆一定能省力", "支点越靠近用力点越省力", "杠杆只能省力不能费力", "省力杠杆一定费距离"],
        "answer": 3,
        "explanation": "省力杠杆的动力臂大于阻力臂，省力但费距离；费力杠杆省距离但费力；使用杠杆不一定省力。支点越靠近阻力点越省力。",
        "difficulty": 2,
        "grade": 6,
        "category": "其他"
    },
    ...
    },
{
        "id": 483,
        "type": "choice",
        "question": "用同样大小的力分别作用在扳手的A、B、C三点，最省力的是作用在（ ）。",
    ...
    },
{
        "id": 551,
        "type": "choice",
        "question": "下列哪种生物在生态系统中不属于分解者？（ ）",
        "options": ["蚯蚓", "蘑菇", "细菌", "老鹰"],
        "answer": 3,
        "explanation": "蘑菇是真菌，能分解有机物，是分解者；自然界中分解者主要是细菌和真菌，还有小型动物，如蚯蚓是分解者。老鹰是消费者。",
        "difficulty": 2,
        "grade": 6,
        "category": "其他"
    },
    ...
    },
{
        "id": 578,
        "type": "choice",
        "question": "关于杠杆的说法正确的是（ ）。",
        "options": ["有的杠杆没有支点", "杠杆一定可以省力", "有的费力杠杆也费距离", "订书机是不省力也不费力杠杆"],
        "answer": 3,
        "explanation": "所有杠杆都有三要素：支点、用力点和阻力点。省力杠杆费距离，费力杠杆省距离。订书机、天平、跷跷板属于不省力不费力杠杆。",
        "difficulty": 2,
        "grade": 6,
        "category": "其他"
    },
    ...
    },
{
        ...
        "options": ["高度相同，斜面越长越费力", "长度相同，斜面越高越省力", "高度相同，斜面越长越省力", "斜面高度与省力无关"],
        "answer": 2,
